...
We provide two files for this assignment. One is a sample file where we give you the sum for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://python-data.dr-chuck.net/comments_244993.json (Sum ends with 13)
...
Please run your program to find the place_id for "Indiana University" and enter the place_id and your Python code below. Hint: The first seven characters of the place_id are "ChIJ76v ..."
